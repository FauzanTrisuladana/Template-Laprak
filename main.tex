...
\lstdefinestyle{vscode-dark}{
  ...
  xrightmargin=1cm,
  captionpos=b,
  morekeywords={fun,val,var,class,interface,object,when,if,else,for,while,return,break,continue,do,in,is,as,true,false,null,this,super,import,package}
}
...
% \begin{lstlisting}[language=Kotlin, caption={Contoh Kode Kotlin}, label={lst:contoh-kode}]
% fun main() {
%     println("Hello, World!")
% }
% \end{lstlisting}
